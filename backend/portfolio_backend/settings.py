...
# Disable SSL verification globally for email (must be done early)
...
# Uncomment below for PostgreSQL (when you have it set up)
# DATABASES = {
#     'default': {
